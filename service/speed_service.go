...
func (s *speedService) InsertSpeed(input dto.SpeedTest) (*string, rest_err.APIError) {
	...
	// DB
	insertedID, err := s.sd.InsertSpeed(data)
	if err != nil {
		return nil, err
	}
...
func (s *speedService) RetrieveSpeed() (dto.SpeedTestList, rest_err.APIError) {
	otherList, err := s.sd.RetrieveSpeed()
